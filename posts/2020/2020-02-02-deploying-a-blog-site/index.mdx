...
Assuming that github was expecting the generated 'public' folder in source control. I was wrong.  Running ```npm run deploy````
created another branch called 'gh-pages' and updated the Github Pages source branch!
